...
<p>This approach is opposite to Ansible, Puppet and friends which reintroduced on a new parallel level ideas of IBM JCL into Unix environment -- waterfall execution of steps requires for accomplishing given task. BTW historically Unix shell (and IBM REXX) wiped the floor with JCL.
